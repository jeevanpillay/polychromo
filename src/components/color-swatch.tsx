...
export const ColorSwatch = memo(function ColorSwatch({ colorClass, name, format }: ColorSwatchProps) {
  ...
  // Always use hex for the background color
  const hexColor = colorClass.startsWith('#') ? colorClass : `#${colorClass}`;
  ...
  return (
    <div className="group relative aspect-square">
      <button
        ...
        className="w-full h-full rounded-sm transition-transform duration-200 ease-in-out hover:scale-110 hover:z-10 focus:outline-none focus:ring-2 border focus:ring-offset-2 focus:ring-blue-500"
